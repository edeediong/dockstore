...
public class RefreshByOrgIT {
    ...
    public void testToolDeletion() throws IOException {
        ...
        testingPostgres.runUpdateStatement(
            "insert into tool (id, giturl, mode, name, namespace, registry, state, dbupdatedate, dbcreatedate) select 100, giturl, mode, 'newtool', namespace, registry, 'PUBLISHED', dbupdatedate, dbcreatedate from tool where id = 2;");
